...
public enum LevelTypeEnum {
    ...
    LEVEL_7(7,"专家",500,1000000,100),
    LEVEL_8(8,"政客",800,2000000,200),
    LEVEL_9(9,"智囊",1000,3000000,500),
    LEVEL_10(10,"谋士",2000,5000000,1000),
    LEVEL_11(11,"军师",3000,8000000,3000),
    LEVEL_12(12,"王佐",3000,8000000,3000);
