...
public class SwaggerConfig {
    ...
    public Docket frontDocket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.news.controller.player"))
    ...
    public Docket backDocket(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.news.controller.manage"))
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .paths(PathSelectors.any())
                .build()
                .globalOperationParameters(getPars())
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("news", "http://127.0.0.1:8009/doc.html", "joy1cs1112@gmail.com");
